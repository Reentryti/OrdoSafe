...
from .views import (
    ...
    PatientSearchAPI, PatientOrdonnanceListAPI, search_ordonnances_by_contact
)
...
urlpatterns = [
    ...
    #Utils
    path('pharmacist/ordonnance/search/', search_ordonnances_by_contact, name='ordonnance_search')
